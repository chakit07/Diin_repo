...
// Note: Now using Stripe Elements for a more integrated payment experience.
// This allows for custom payment forms and better error handling.
...
const plans = [
  {
    ...
    type: "One-time",
    description:
      "Perfect for small businesses looking for a professional web presence.",
    features: [
      "Custom Design",
      "Mobile Responsive",
      "SEO Optimization",
  ...
  },
  {
    ...
    type: "One-time",
    description:
      "Worry-free support and ongoing maintenance for your digital assets.",
    features: [
      "Security Updates",
      "Bug Fixes",
      "Regular Backups",
  ...
  },
  {
    ...
    type: "One-time",
    description:
      "Scalable and feature-rich mobile or web application development.",
    features: [
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 max-w-2xl text-xl text-gray-500 mx-auto">
            Transparent pricing with no hidden fees. All plans include standard
            support.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center px-4 py-2 bg-primary-50 rounded-full text-primary-700 text-sm font-medium">
            ...
            <a href="/contact" className="ml-1 underline font-bold">
              Contact us
            </a>
          </div>
        </div>
